        ...
        for txt in self:
            ...
            for txt_line in txt.txt_ids:
                ...
                if txt_line.voucher_id == txt_line.invoice_id.wh_iva_id:
                    ...
                    amount_total2 = str(round(amount_total11*sign, 2))
                    amount_untaxed = txt_line.untaxed
                else:
                    amount_total2 = str(round(amount_total*sign, 2))
                ...
                txt_string = (
                    ...
                    self.formato_cifras(txt_line.amount_withheld2) + '\t' + document_affected + '\t' + voucher_number
